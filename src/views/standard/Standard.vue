          ...
          if (res.httpStatus == 200) {
            this.navList = res.result.map((item, index) => {
              return {
                ...
                // path:
                //   item.categoryName == "资料审查"
                //     ? "/index/standard/standardDataReview"
                //     : "/index/standard/assess"
              };
            });
            this.cindex = this.navList[0].standardId;
            // if(this.$route.path == '/index/standard/standardDataReview'){
            //   this.changeNav(this.navList[1])
            // }else{
            //   this.changeNav(this.navList[0])
            // }
            this.getTreeData(this.cindex);
